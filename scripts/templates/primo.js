...
<head>
  ...
  <meta name="description" content="Documenti necessari per il primo rilascio del permesso per ${escapedTipo}">
  <title>Documenti ${escapedTipo} - Primo Rilascio - SOS Permesso</title>
