...
- ✓ 63 document detail pages from Notion — v1.1
...
- ✓ Permit pages generated from Notion Q&A content — v1.7
...
| Slug mapping via JSON | Centralized URL aliasing | ~~Removed in v3.1~~ — flat architecture eliminated redirects |
...
| Flat permit architecture | 1 Notion page = 1 HTML page, simpler than variants | ✓ Good — v3.1 (replaced v1.7 variants) |
