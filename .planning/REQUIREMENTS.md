...
Requirements for French and Spanish translation via the same Notion + 11ty pipeline as EN.

### Translation Script

- [ ] **TRANS-01**: `npm run translate --lang fr` translates IT permit Q&A and document content to French via Claude API
- [ ] **TRANS-02**: `npm run translate --lang es` translates IT permit Q&A and document content to Spanish via Claude API
- [ ] **TRANS-03**: French translation glossary created (legal/immigration terms mapped to FR equivalents)
- [ ] **TRANS-04**: Spanish translation glossary created (legal/immigration terms mapped to ES equivalents)
- [ ] **TRANS-05**: Section-level hashing prevents re-translating unchanged sections for FR/ES (same mechanism as EN)

### Notion Databases

- [ ] **NOTION-01**: French Notion database created with translated permit Q&A + document content
- [ ] **NOTION-02**: Spanish Notion database created with translated permit Q&A + document content
...
- [ ] **ESGEN-01**: ES permit pages generated by 11ty from Notion ES data at `/es/permesso-*.html`
- [ ] **ESGEN-02**: ES document pages (primo + rinnovo) generated by 11ty at `/es/documenti-*-primo.html` and `/es/documenti-*-rinnovo.html`
- [ ] **ESGEN-03**: ES static pages (homepage, database listing, documenti-questura, chi-siamo) created at `/es/`

### SEO

- [ ] **SEO-01**: Hreflang tags in base layout include FR and ES alternates for all page types
- [ ] **SEO-02**: sitemap-fr.xml and sitemap-es.xml added to sitemap index with hreflang cross-references
...
| Additional languages (ZH, AR) | FR/ES only for v4.0, architecture supports adding later |
...
| FGEN-02 | TBD | Pending |
| FGEN-03 | TBD | Pending |
| ESGEN-01 | TBD | Pending |
| ESGEN-02 | TBD | Pending |
| ESGEN-03 | TBD | Pending |
| SEO-01 | TBD | Pending |
| SEO-02 | TBD | Pending |
