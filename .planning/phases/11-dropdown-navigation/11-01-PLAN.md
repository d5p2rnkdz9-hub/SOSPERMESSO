...
<ul class="nav-menu" id="nav-menu">
  ...
  <li class="nav-item has-dropdown">
    ...
    <ul class="nav-dropdown" role="menu">
      <li role="none"><a href="src/pages/guide/protezione-internazionale.html" class="dropdown-link" role="menuitem">Protezione internazionale</a></li>
      <li role="none"><a href="src/pages/guide/ricongiungimento-familiare.html" class="dropdown-link" role="menuitem">Ricongiungimento familiare</a></li>
      <li role="none"><a href="src/pages/guide/dizionario.html" class="dropdown-link" role="menuitem">Dizionario</a></li>
    </ul>
  </li>
...
**Path verification:**
Before adding, verify these paths exist or will be created:
- src/pages/database.html (exists)
- src/pages/documenti-questura.html (check if exists, may need adjustment)
- src/pages/guide/protezione-internazionale.html (check structure)
- src/pages/guide/ricongiungimento-familiare.html
- src/pages/guide/dizionario.html

If paths don't exist exactly, use the actual paths from the codebase (e.g., dizionario.html may be at src/pages/dizionario.html not src/pages/guide/).
  </action>
  <verify>
...
5. Verify all dropdown links are clickable and lead to correct pages
  </verify>
  <done>
