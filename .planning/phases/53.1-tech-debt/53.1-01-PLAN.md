...
<task type="auto">
  ...
  <files>_data/footer.js, _includes/layouts/base.liquid, netlify.toml</files>
  <action>
**Footer fix:**
...
Add these before the security headers section in netlify.toml.
  ...
  <done>Footer shows "Contattaci" link in all three languages. Netlify redirects /index.html to / for all three language homepages.</done>
</task>
