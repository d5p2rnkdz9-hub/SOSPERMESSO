...
files_modified:
  ...
  - Note: 40 redirect-only files excluded, 1 file (index.html) already complete
autonomous: true
...
- 1 has only Collabora (index.html, already complete)
</context>
...
- app.js handles dropdown-link click events for menu close
  ...
  <done>
- All 3 dropdown items present in all 98 full-page files
...
6. Mobile navigation CSS and JS handle dropdown-link class
</success_criteria>
