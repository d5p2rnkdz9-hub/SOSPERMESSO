...
must_haves:
  truths:
    ...
    - "All 7 template filters are registered and available: linkToDizionario, normalizeDocumentName, getDocumentClass, isDisputed, escapeHtml, parseDocNotes, formatNotesContent"
