...
<task type="auto">
  ...
  <action>
ONLY EXECUTE IF USER APPROVED IN TASK 2.
...
4. Open variant page in browser - verify CSS loads, links work
  ...
  <done>Variant pages generated in subfolders; parent pages link to variants; all paths resolve correctly</done>
</task>
...
2. User approved or modified variant structure
3. If approved: variant folders and pages exist
4. Parent pages contain links to variant children
5. Variant pages load correctly (CSS, images, navigation all work)
</verification>
