...
4. If build fails, diagnose and fix. Common issues:
  ...
  <verify>
Build succeeds with zero errors. FR page counts match expectations. FR content is French (not English/Italian). Hreflang tags present. IT and EN pages unaffected.
  </verify>
  <done>
Full build produces all FR pages (permits + documents + static), EN and IT pages still build correctly, no DuplicatePermalinkOutputError, French content renders correctly.
  </done>
</task>
